...
class ALEX:
    ...
    def train_and_test(self, n_epoch=100, batchsize=100):
        ...
        while epoch <= n_epoch:
            ...
            train_mean = 'train mean loss={}, accuracy={}'.format(sum_train_loss / self.n_train,
            ...
            test_mean = 'test mean loss={}, accuracy={}'.format(sum_test_loss / self.n_test,
        ...
        log_filename = "log_64x64_loop100_brand" + d.strftime("%Y-%m-%d_%H%M%S") + ".txt"
